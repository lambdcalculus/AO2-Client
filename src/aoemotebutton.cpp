...
{
  // In the land of AO2, cohesion and consistency is unknown to the world for the sake of lazy-users convenience!
  ...
  if (p_enabled)
  {
    const QString enabled_texture_path = ao_app->get_character_path(p_chr, QString("emotions/button%1_on.png").arg(true_emote_number));
